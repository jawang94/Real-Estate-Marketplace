...
contract Ownable {
    ...
    //  1)b. a public getter function for the private variable _owner
...
contract Pausable is Ownable {
    ...
    modifier paused() {
        require(_paused == true, "Contract is active");
        _;
    }
    ...
    function setPaused(bool mode) public onlyOwner {
        require(_paused != mode, "Mode is the same. Passing...");
        _paused = mode;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            ownerOf(tokenId) != to,
            "Address cannot be same as owner of token"
        );
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        address owner = getOwner();
        require(
            msg.sender == owner || isApprovedForAll(owner, msg.sender),
            "Sender does not have permissions"
        );
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        if (tokenApproval != address(0x0)) return tokenApproval;
    }
    ...
    function _transferFrom(
        ...
        require(
            ...
            "From address does not match owner of token"
        );
        // TODO: require token is being transfered to valid address
        require(to != address(0x0), "Address is invalid");
        // TODO: clear approval
...
contract JSONToken is ERC721Metadata {
    string private _name = "json";
    string private _symbol = "JSON";
    string private _baseTokenURI =
